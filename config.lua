...
Config.Locations = {
    ["main"] = {
        label = "Garbage Depot",
        coords = vec3(-313.84, -1522.82, 27.56),
    },
    ["vehicle"] = {
    ...
    ["paycheck"] = {
        ...
        coords = vec3(-321.45, -1545.86, 31.02),
    },
    ["trashcan"] ={
        [1] = {
            name = "forumdrive",
        ...
        [4] = {
            name = "davisave",
            coords = vec4(424.98, -1523.57, 29.28, 120.08),
        },
        [5] = {
            name = "littlebighornavenue",
            coords = vec4(488.49, -1284.1, 29.24, 138.5),
        },
        [6] = {
            name = "vespucciblvd",
            coords = vec4(307.47, -1033.6, 29.03, 46.5),
        },
        [7] = {
            name = "elginavenue",
            coords = vec4(239.19, -681.5, 37.15, 178.5),
        },
        [8] = {
            name = "elginavenue2",
            coords = vec4(543.51, -204.41, 54.16, 199.5),
        },
        [9] = {
            name = "powerstreet",
            coords = vec4(268.72, -25.92, 73.36, 90.5),
        },
        [10] = {
            name = "altastreet",
            coords = vec4(267.03, 276.01, 105.54, 332.5),
        },
        [11] = {
            name = "didiondrive",
            coords = vec4(21.65, 375.44, 112.67, 323.5),
        },
        [12] = {
            name = "miltonroad",
            coords = vec4(-546.9, 286.57, 82.85, 127.5),
        },
        [13] = {
            name = "eastbourneway",
            coords = vec4(-683.23, -169.62, 37.74, 267.5),
        },
        [14] = {
            name = "eastbourneway2",
            coords = vec4(-771.02, -218.06, 37.05, 277.5),
        },
        [15] = {
            name = "industrypassage",
            coords = vec4(-1057.06, -515.45, 35.83, 61.5),
        },
        [16] = {
            name = "boulevarddelperro",
            coords = vec4(-1558.64, -478.22, 35.18, 179.5),
        },
        [17] = {
            name = "sandcastleway",
            coords = vec4(-1350.0, -895.64, 13.36, 17.5),
        },
        [18] = {
            name = "magellanavenue",
            coords = vec4(-1243.73, -1359.72, 3.93, 287.5),
        },
        [19] = {
            name = "palominoavenue",
            coords = vec4(-845.87, -1113.07, 6.91, 253.5),
        },
        [20] = {
            name = "southrockforddrive",
            coords = vec4(-635.21, -1226.45, 11.8, 143.5),
        },
        [21] = {
            name = "southarsenalstreet",
            coords = vec4(-587.74, -1739.13, 22.47, 339.5),
        },
    },
